...
武汉大学资源与环境科学学院《健康地理学》课程(202101014，2025秋季)
...
###### 2.3.2 系统动力学模型
###### 2.3.3 房室模型
##### 2.4 本章总结：从空间复杂性的系统认知，到对“人地耦合”机制的仿真挖掘
#### 3 健康地理中的人工智能——赋能与洞察
##### 3.1 引言: AI如何赋能健康地理
##### 3.2 机器学习
###### 3.2.1 数据集
...
###### 3.2.5 集成学习
##### 3.3 深度学习
###### 3.3.1 计算机视觉（CV）应用：街景图像、遥感影像解读
###### 3.3.2 多模态数据集成与高级预测模型
##### 3.4 可解释人工智能（XAI）：打开“黑箱”，建立信任
##### 3.5 大语言模型（LLM）与生成式AI：知识引擎与决策辅助
###### 3.5.1 健康领域垂向大模型
###### 3.5.2 基础模型的微调与调整
##### 3.6 终极议题：融合、伦理与未来
###### 3.6.1 电车难题
###### 3.6.2 算法公平性、隐私保护与负责任创新
...
1. 吴息凤, 庄贵华, 金焰, 王超龙, 毛琛 (主编). (2024). *医学大数据与人工智能应用* (教育部101计划核心课程教材). 北京: 人民卫生出版社. ISBN: 9787117387644.
